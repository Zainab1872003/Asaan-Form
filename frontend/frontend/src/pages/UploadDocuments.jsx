...
import { Upload, FileText, Image, CheckCircle, Loader } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Upload the documents needed to fill the forms (ID, certificates, etc.)
          </p>
        </div>
        ...
        {selectedFiles.length > 0 && (
          <div className="mt-8 bg-white rounded-2xl p-6 shadow-lg">
            ...
            <button
              ...
              className="mt-6 w-full py-3 bg-primary-blue text-white rounded-lg font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isProcessing ? (
                <>
        ...
        {isProcessing && (
          <div className="mt-8 bg-primary-blue/10 rounded-2xl p-8 text-center">
            <Loader className="w-16 h-16 text-primary-blue mx-auto mb-4 animate-spin" />
            <h3 className="text-xl font-semibold text-primary-olive mb-2">
              Processing Your Forms
            </h3>
            <p className="text-gray-600">
              Our AI is analyzing your documents and filling the forms. This may take a few moments...
            </p>
          </div>
        )}
      </div>
